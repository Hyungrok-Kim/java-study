...
// 한 파일안에 public은 한 개의 class에만 붙일 수 있다.
public class ClassInfo {
	 ...
	 *              .java의 파일명과 동일해야 한다.
	 * }
	 * public   final(종단, 끝), abstract(미완성된)    // final은 상속의 개념에서 더이상 자식을 만들지않겠다. 누군가가 나를 상속받아서 자식을 만들어 내지않겠다.
	 * default(만약 접근제한자가 생략되었을 경우)  			// abstract는 내가 미완성이니까 반드시 자식을 만들어 주세요 라는 개념 
	 * 
	 * - 사용 예시 -
